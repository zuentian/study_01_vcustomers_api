...
(
  ID        VARCHAR2(36) default NULL  not null
    constraint LOGIN_INFO_ID_PK
    primary key,
  TYPE      NUMBER,
...
comment on column LOGIN_INFO.TYPE
is '登录账号类型'
/

comment on column LOGIN_INFO.USER_CODE
is '登录账号'
/
...
comment on column LOGIN_INFO.STATUE
is '登录状态'
/
...
comment on column USER_INFO.NAME_BAK
is '用户备用姓名'
/
